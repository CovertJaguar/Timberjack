...
package mods.timberjack.client.rendering;
...
public class RenderEntityTimber extends Render<EntityTimber> {
    public RenderEntityTimber(RenderManager renderManagerIn) {
     ...
     */
    public void doRender(EntityTimber entity, double x, double y, double z, float entityYaw, float partialTicks) {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityTimber entity) {
